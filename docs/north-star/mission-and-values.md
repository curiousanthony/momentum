...
Help developers become more capable, consistent, and high-leverage with AI coding
tools by making invisible progress visible.
...
- `Insight`: reveal patterns the user would struggle to reconstruct from memory alone
- `Motivation`: make progress tangible without feeling childish or manipulative
- `Empowerment`: turn reflection into confidence, better habits, and better decisions
...
- to confident, high-output product creation
...
The product should de-emphasize:
...
- `../personas/progression-stages.md`
- `../research/design-principles-summary.md`
